...
def update_destination_codes():
    ...
    for city in sheety_data['prices']:
        ...
        kiwi_resp = requests.get(url=KIWI_URL, headers=KIWI_HEADERS, params=kiwi_iata_params)
...
for destination in city_and_price_list:
    ...
    kiwi_resp = requests.get(url=KIWI_URL, headers=KIWI_HEADERS, params=kiwi_params)
